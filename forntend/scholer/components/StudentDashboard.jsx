...
function StudentDashboard() {
  ...
  const feesProgress = (parseFloat(fees.paidFees.replace(/[^0-9.]/g, "")) / parseFloat(fees.totalFees.replace(/[^0-9.]/g, ""))) * 100;
            ...
            <Box sx={{ mt: 4 }}>
              <Card sx={{ mb: 3 }}>
                <CardContent>
                  ...
                  <Typography variant="h4" color="primary.main">{fees.totalFees}</Typography>
                </CardContent>
              </Card>
              <Card sx={{ mb: 3 }}>
                <CardContent>
                  <Typography variant="h6">Paid Fees</Typography>
                  <Typography variant="h4" color="primary.main">{fees.paidFees}</Typography>
                </CardContent>
              </Card>
              <Card>
                <CardContent>
                  <Typography variant="h6">Remaining Fees</Typography>
                  <Typography variant="h4" color="primary.main">{fees.remainingFees}</Typography>
                </CardContent>
              </Card>
              <Box mt={3}>
                <Typography variant="h6" gutterBottom>Fees Progress</Typography>
                <LinearProgress
                  variant="determinate"
                  value={feesProgress}
